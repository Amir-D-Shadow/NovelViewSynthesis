...
class ResUnit(nn.Module):
    ...
    def __init__(self,in_channels,mid_channels,out_channels, kernel_size, stride=1,padding=0,normalization=None,track_running_stats=False):
...
class FeatureResUNet(nn.Module):
    ...
    def __init__(self,normalization=None,track_running_stats=False):
        ...
        #input pre-encoded in: m x 12 x H x W , out: m x 16 x H x W
        ...
        #input 0 in: m x 16 x H x W , out: m x 32 x H//2 x W//2 : connection_0
        self.res0unit = ResUnit(in_channels = 16,
                                mid_channels = 32,
                                out_channels = 16,
                                kernel_size = 3,
                                stride=1,
        ...
        #block 1 in: m x 32 x H//2 x W//2, out: m x 64 x H//4 x W//4 : connection_1
        self.res1unit = ResUnit(in_channels = 32,
                                mid_channels = 64,
                                out_channels = 32,
                                kernel_size = 3,
                                stride=1,
        ...
        #block 2 in: m x 64 x H//4 x W//4, out: m x 128 x H//8 x W//8 : connection_2
        self.res2unit = ResUnit(in_channels = 64,
                                mid_channels = 128,
                                out_channels = 64,
                                kernel_size = 3,
                                stride=1,
        ...
        #block 3 in: m x 128 x H//8 x W//8, out: m x 256 x H//16 x W//16 : connection_3
        self.res3unit = ResUnit(in_channels = 128,
                                mid_channels = 256,
                                out_channels = 128,
                                kernel_size = 3,
                                stride=1,
        ...
        #BottleNeck in: m x 256 x H//16 x W//16, out: m x 256 x H//8 x W//8 
        self.BottleNeck_ResUnit = ResUnit(in_channels = 256,
                                          mid_channels = 512,
                                          out_channels = 256,
                                          kernel_size = 3,
                                          stride=1,
        ...
        self.BottleNeck_CNL = CNL(in_channels=256,
                                  out_channels=512,
                                  kernel_size=3,
                                  stride=1,
                                  padding=1,
        ...
        self.BottleNeck_UpCNL = UpCNL(in_channels = 512,
                                      out_channels = 256,
                                      scale_factor = 2,
                                      kernel_size = 3,
                                      stride = 1,
        ...
        #block 4 (decode block 3) in: m x 512 x H//8 x W//8 , out: m x 128 x H//4 x W//4
        self.res4unit = ResUnit(in_channels = 512,
                                mid_channels = 512,
                                out_channels = 512,
                                kernel_size = 3,
                                stride=1,
        ...
        self.UPCNL4 = UpCNL(in_channels = 256,
                            out_channels = 128,
                            scale_factor = 2,
                            kernel_size = 3,
                            stride = 1,
        ...
        #block 5 (decode block 2) in: m x 256 x H//4 x W//4 , out: m x 64 x H//2 x W//2
        self.res5unit = ResUnit(in_channels = 256,
                                mid_channels = 128,
                                out_channels = 256,
                                kernel_size = 3,
                                stride = 1,
        ...
        self.UPCNL5 = UpCNL(in_channels = 128,
                            out_channels = 64,
                            scale_factor = 2,
                            kernel_size = 3,
                            stride = 1,
        ...
        #block 6 (decode block 1) in: m x 128 x H//2 x W//2 , out: m x 32 x H x W
        self.res6unit = ResUnit(in_channels = 128,
                                mid_channels = 64,
                                out_channels = 128,
                                kernel_size = 3,
                                stride = 1,
        ...
        self.UPCNL6 = UpCNL(in_channels = 64,
                            out_channels = 32,
                            scale_factor = 2,
                            kernel_size = 3,
                            stride = 1,
        ...
        #block 7 (decode input 0) in: m x 64 x H x W , out: m x 3 x H x W
        self.res7unit = ResUnit(in_channels = 64,
                                mid_channels = 32,
                                out_channels = 64,
                                kernel_size = 3,
                                stride = 1,
...
if __name__ == "__main__":
    ...
    dummy_input = torch.randn(4, 12, 192, 320)
